...
(function($){
function init(_1eb){
$(_1eb).addClass("agenttip-f");
};
function _1ec(_1ed){
var opts=$.data(_1ed,"agenttip").options;
$(_1ed).unbind(".agenttip").bind(opts.showEvent+".agenttip",function(e){
$(_1ed).agenttip("show",e);
}).bind(opts.hideEvent+".agenttip",function(e){
$(_1ed).agenttip("hide",e);
}).bind("mousemove.agenttip",function(e){
if(opts.trackMouse){
opts.trackMouseX=e.pageX;
opts.trackMouseY=e.pageY;
$(_1ed).agenttip("reposition");
}
});
};
function _1ee(_1ef){
var _1f0=$.data(_1ef,"agenttip");
if(_1f0.showTimer){
...
$(_1f2).agenttip("arrow").css("left",tip._outerWidth()/2+pos.left);
pos.left=0;
}
}else{
...
$(_1f2).agenttip("arrow").css("left",tip._outerWidth()/2-(pos.left-left));
}
}
}
}
...
tip.removeClass("agenttip-top agenttip-bottom agenttip-left agenttip-right").addClass("agenttip-"+opts.position);
var left,top;
if(opts.trackMouse){
t=$();
...
var _1f8=$.data(_1f7,"agenttip");
var opts=_1f8.options;
var tip=_1f8.tip;
if(!tip){
tip=$("<div tabindex=\"-1\" class=\"agenttip\">"+"<div class=\"agenttip-content\"></div>"+"<div class=\"agenttip-arrow-outer\"></div>"+"<div class=\"agenttip-arrow\"></div>"+"</div>").appendTo("body");
_1f8.tip=tip;
_1f9(_1f7);
}
_1ee(_1f7);
_1f8.showTimer=setTimeout(function(){
$(_1f7).agenttip("reposition");
tip.show();
opts.onShow.call(_1f7,e);
var _1fa=tip.children(".agenttip-arrow-outer");
var _1fb=tip.children(".agenttip-arrow");
...
_201.tip.children(".agenttip-content").html(cc);
opts.onUpdate.call(_1ff,cc);
};
function _202(_203){
var _204=$.data(_203,"agenttip");
if(_204){
_1ee(_203);
...
$.removeData(_203,"agenttip");
$(_203).unbind(".agenttip").removeClass("agenttip-f");
opts.onDestroy.call(_203);
}
};
$.fn.agenttip=function(_205,_206){
if(typeof _205=="string"){
return $.fn.agenttip.methods[_205](this,_206);
}
_205=_205||{};
return this.each(function(){
var _207=$.data(this,"agenttip");
if(_207){
$.extend(_207.options,_205);
}else{
$.data(this,"agenttip",{options:$.extend({},$.fn.agenttip.defaults,$.fn.agenttip.parseOptions(this),_205)});
init(this);
}
_1ec(this);
_1f9(this);
...
$.fn.agenttip.methods={options:function(jq){
return $.data(jq[0],"agenttip").options;
},tip:function(jq){
return $.data(jq[0],"agenttip").tip;
},arrow:function(jq){
return jq.agenttip("tip").children(".agenttip-arrow-outer,.agenttip-arrow");
},show:function(jq,e){
return jq.each(function(){
_1f6(this,e);
});
...
$.fn.agenttip.parseOptions=function(_209){
var t=$(_209);
...
$.fn.agenttip.defaults={position:"bottom",content:null,trackMouse:false,deltaX:0,deltaY:0,showEvent:"mouseenter",hideEvent:"mouseleave",showDelay:200,hideDelay:100,onShow:function(e){
},onHide:function(e){
...
if(!$.isArray(opts.agents)){
_225.find("div.panel-agent .panel-agent-a").appendTo(opts.agents);
}
_225.empty();
...
var agent=$("<div class=\"panel-agent\"></div>").appendTo(_225);
agent.bind("click",function(e){
e.stopPropagation();
});
if(opts.agents){
if($.isArray(opts.agents)){
$.map(opts.agents,function(t){
_227(agent,t.iconCls,eval(t.handler));
});
}else{
$(opts.agents).children().each(function(){
$(this).addClass($(this).attr("iconCls")).addClass("panel-agent-a").appendTo(agent);
});
}
}
if(opts.collapsible){
_227(agent,"panel-agent-collapse",function(){
...
if(opts.minimizable){
_227(agent,"panel-agent-min",function(){
_24b(_21e);
});
}
if(opts.maximizable){
_227(agent,"panel-agent-max",function(){
...
if(opts.closable){
_227(agent,"panel-agent-close",function(){
_239(_21e);
});
}
}
...
t.find(".agenttip-f").each(function(){
...
var agent=_236.children(".panel-header").find("a.panel-agent-restore");
if(agent.length){
opts.maximized=true;
}
...
var agent=_244.children(".panel-header").find("a.panel-agent-collapse");
if(opts.collapsed==true){
return;
}
body.stop(true,true);
...
agent.addClass("panel-agent-expand");
if(_243==true){
...
var agent=_248.children(".panel-header").find("a.panel-agent-collapse");
...
agent.removeClass("panel-agent-expand");
if(_247==true){
...
var agent=_24a.children(".panel-header").find("a.panel-agent-max");
if(opts.maximized==true){
return;
}
agent.addClass("panel-agent-restore");
...
var agent=_250.children(".panel-header").find("a.panel-agent-max");
if(opts.maximized==false){
return;
}
_250.show();
agent.removeClass("panel-agent-restore");
...
return $.extend({},$.parser.parseOptions(_266,["id","width","height","left","top","title","iconCls","cls","headerCls","bodyCls","agents","href","method","header","footer",{cache:"boolean",fit:"boolean",border:"boolean",noheader:"boolean"},{collapsible:"boolean",minimizable:"boolean",maximizable:"boolean"},{closable:"boolean",collapsed:"boolean",minimized:"boolean",maximized:"boolean",closed:"boolean"},"openAnimation","closeAnimation",{openDuration:"number",closeDuration:"number"},]),{loadingMessage:(t.attr("loadingMessage")!=undefined?t.attr("loadingMessage"):undefined),header:(hh.length?hh.removeClass("panel-header"):undefined),footer:(ff.length?ff.removeClass("panel-footer"):undefined)});
};
$.fn.panel.defaults={id:null,title:null,iconCls:null,width:"auto",height:"auto",left:null,top:null,cls:null,headerCls:null,bodyCls:null,style:{},href:null,cache:true,fit:false,border:true,doSize:true,noheader:false,content:null,collapsible:false,minimizable:false,maximizable:false,closable:false,collapsed:false,minimized:false,maximized:false,closed:false,openAnimation:false,openDuration:400,closeAnimation:false,closeDuration:400,agents:null,footer:null,header:null,queryParams:{},method:"get",href:null,loadingMessage:"Loading...",loader:function(_267,_268,_269){
...
if(opts.agentbar){
if($.isArray(opts.agentbar)){
$(_292).siblings("div.dialog-agentbar").remove();
var _293=$("<div class=\"dialog-agentbar\"><table cellspacing=\"0\" cellpadding=\"0\"><tr></tr></table></div>").appendTo(win);
var tr=_293.find("tr");
for(var i=0;i<opts.agentbar.length;i++){
var btn=opts.agentbar[i];
if(btn=="-"){
$("<td><div class=\"dialog-agent-separator\"></div></td>").appendTo(tr);
}else{
var td=$("<td></td>").appendTo(tr);
var agent=$("<a href=\"javascript:void(0)\"></a>").appendTo(td);
agent[0].onclick=eval(btn.handler||function(){
});
agent.linkbutton($.extend({},btn,{plain:true}));
}
}
}else{
$(opts.agentbar).addClass("dialog-agentbar").appendTo(win);
$(opts.agentbar).show();
}
}else{
$(_292).siblings("div.dialog-agentbar").remove();
...
var tb=t.siblings(".dialog-agentbar");
...
var t=$(_2a2);
return $.extend({},$.fn.window.parseOptions(_2a2),$.parser.parseOptions(_2a2,["agentbar","buttons"]),{agentbar:(t.children(".dialog-agentbar").length?t.children(".dialog-agentbar").removeClass("dialog-agentbar"):undefined),buttons:(t.children(".dialog-button").length?t.children(".dialog-button").removeClass("dialog-button"):undefined)});
};
$.fn.dialog.defaults=$.extend({},$.fn.window.defaults,{title:"New Dialog",collapsible:false,minimizable:false,maximizable:false,resizable:false,agentbar:null,buttons:null});
})(jQuery);
(function($){
function _2a3(){
...
var agent=_2d9.children("div.panel-agent");
agent.children("a.panel-agent-collapse").hide();
var t=$("<a href=\"javascript:void(0)\"></a>").addClass("accordion-collapse accordion-expand").appendTo(agent);
...
var agent=_30f.children("div.tabs-agent:not(.tabs-agent-hidden)");
...
agent._outerHeight(_312);
var _313=_30c(_30f.find("ul.tabs"));
var _314=_30f.width()-agent._outerWidth();
if(_313>_314){
_310.add(_311).show()._outerHeight(_312);
if(opts.agentPosition=="left"){
agent.css({left:_310.outerWidth(),right:""});
wrap.css({marginLeft:_310.outerWidth()+agent._outerWidth(),marginRight:_311._outerWidth(),width:_314-_310.outerWidth()-_311.outerWidth()});
}else{
agent.css({left:"",right:_311.outerWidth()});
wrap.css({marginLeft:_310.outerWidth(),marginRight:_311.outerWidth()+agent._outerWidth(),width:_314-_310.outerWidth()-_311.outerWidth()});
}
}else{
_310.add(_311).hide();
if(opts.agentPosition=="left"){
agent.css({left:0,right:""});
wrap.css({marginLeft:agent._outerWidth(),marginRight:0,width:_314});
}else{
agent.css({left:"",right:0});
wrap.css({marginLeft:0,marginRight:agent._outerWidth(),width:_314});
}
}
};
function _315(_316){
...
$(opts.agents).addClass("tabs-agent").appendTo(_317);
$(opts.agents).show();
}else{
_317.children("div.tabs-agent").remove();
var _318=$("<div class=\"tabs-agent\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"height:100%\"><tr></tr></table></div>").appendTo(_317);
var tr=_318.find("tr");
for(var i=0;i<opts.agents.length;i++){
var td=$("<td></td>").appendTo(tr);
var agent=$("<a href=\"javascript:void(0);\"></a>").appendTo(td);
agent[0].onclick=eval(opts.agents[i].handler||function(){
});
agent.linkbutton($.extend({},opts.agents[i],{plain:true}));
}
}
}else{
_317.children("div.tabs-agent").remove();
...
_31d.children("div.tabs-scroller-left,div.tabs-scroller-right,div.tabs-agent:not(.tabs-agent-hidden)").css("display",opts.showHeader?"block":"none");
...
var _31f=_31d.width()-_31d.children(".tabs-agent:not(.tabs-agent-hidden)")._outerWidth();
...
if(opts.agents){
var _352=tab.find("span.tabs-p-agent");
if(!_352.length){
var _352=$("<span class=\"tabs-p-agent\"></span>").insertAfter(tab.find("a.tabs-inner"));
}
if($.isArray(opts.agents)){
_352.empty();
for(var i=0;i<opts.agents.length;i++){
var t=$("<a href=\"javascript:void(0)\"></a>").appendTo(_352);
t.addClass(opts.agents[i].iconCls);
if(opts.agents[i].handler){
t.bind("click",{handler:opts.agents[i].handler},function(e){
...
$(opts.agents).children().appendTo(_352);
}
...
tab.find("span.tabs-p-agent").remove();
...
var agent=$(_371).find(">.tabs-header>.tabs-agent");
if(_372){
agent.removeClass("tabs-agent-hidden").show();
}else{
agent.addClass("tabs-agent-hidden").hide();
}
...
},showAgent:function(jq){
return jq.each(function(){
_370(this,true);
});
},hideAgent:function(jq){
return jq.each(function(){
_370(this,false);
});
...
return $.extend({},$.parser.parseOptions(_382,["agents","agentPosition","tabPosition",{fit:"boolean",border:"boolean",plain:"boolean"},{headerWidth:"number",tabWidth:"number",tabHeight:"number",selected:"number"},{showHeader:"boolean",justified:"boolean",narrow:"boolean",pill:"boolean"}]));
};
$.fn.tabs.defaults={width:"auto",height:"auto",headerWidth:150,tabWidth:"auto",tabHeight:27,selected:0,showHeader:true,plain:false,fit:false,border:true,justified:false,narrow:false,pill:false,agents:null,agentPosition:"right",tabPosition:"top",scrollIncrement:100,scrollDuration:400,onLoad:function(_383){
...
var agent=$(this).panel("header").children("div.panel-agent");
agent.children("a.panel-agent-collapse").hide();
...
var t=agent.children("a."+_3a6);
if(!t.length){
t=$("<a href=\"javascript:void(0)\"></a>").addClass(_3a6).appendTo(agent);
...
p.panel($.extend({},$.fn.layout.paneldefaults,{cls:("layout-expand layout-expand-"+dir),title:"&nbsp;",closed:true,minWidth:0,minHeight:0,doSize:false,agents:[{iconCls:icon,handler:function(){
_3c2(_3b3,_3b4);
return false;
}}]}));
...
$(_485).agenttip($.extend({},opts.tipOptions,{content:_486.message,position:opts.tipPosition,deltaX:opts.deltaX})).agenttip("show");
_486.tip=true;
};
function _47a(_487){
var _488=$.data(_487,"validatebox");
if(_488&&_488.tip){
$(_487).agenttip("reposition");
}
};
function _47e(_489){
...
$(this).agenttip("tip").css({color:"#000",borderColor:"#CC9933",backgroundColor:"#FFFFCC"});
},onHide:function(){
$(this).agenttip("destroy");
...
if(opts.agentbar){
if($.isArray(opts.agentbar)){
$("div.datagrid-agentbar",_603).remove();
var tb=$("<div class=\"datagrid-agentbar\"><table cellspacing=\"0\" cellpadding=\"0\"><tr></tr></table></div>").prependTo(_603);
var tr=tb.find("tr");
for(var i=0;i<opts.agentbar.length;i++){
var btn=opts.agentbar[i];
if(btn=="-"){
...
$(opts.agentbar).addClass("datagrid-agentbar").prependTo(_603);
$(opts.agentbar).show();
}
}else{
$("div.datagrid-agentbar",_603).remove();
