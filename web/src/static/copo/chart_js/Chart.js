...
require('./core/core.agenttip')(Chart);
...
},{"./charts/Chart.Bar":8,"./charts/Chart.Bubble":9,"./charts/Chart.Doughnut":10,"./charts/Chart.Line":11,"./charts/Chart.PolarArea":12,"./charts/Chart.Radar":13,"./charts/Chart.Scatter":14,"./controllers/controller.bar":15,"./controllers/controller.bubble":16,"./controllers/controller.doughnut":17,"./controllers/controller.line":18,"./controllers/controller.polarArea":19,"./controllers/controller.radar":20,"./core/core.animation":21,"./core/core.controller":22,"./core/core.datasetController":23,"./core/core.element":24,"./core/core.helpers":25,"./core/core.js":26,"./core/core.layoutService":27,"./core/core.legend":28,"./core/core.plugin.js":29,"./core/core.scale":30,"./core/core.scaleService":31,"./core/core.title":32,"./core/core.agenttip":33,"./elements/element.arc":34,"./elements/element.line":35,"./elements/element.point":36,"./elements/element.rectangle":37,"./scales/scale.category":38,"./scales/scale.linear":39,"./scales/scale.logarithmic":40,"./scales/scale.radialLinear":41,"./scales/scale.time":42}],8:[function(require,module,exports){
"use strict";
...
module.exports = function(Chart) {
	...
	var defaultConfig = {
		...
		agenttips: {
			callbacks: {
				title: function(agenttipItems, data) {
					// Title doesn't make sense for scatter since we format the data as a point
					return '';
				},
				label: function(agenttipItem, data) {
					return '(' + agenttipItem.xLabel + ', ' + agenttipItem.yLabel + ')';
				}
			}
		}
	};
	...
	Chart.defaults.bubble = {
		...
		agenttips: {
			callbacks: {
				...
				label: function(agenttipItem, data) {
					var datasetLabel = data.datasets[agenttipItem.datasetIndex].label || '';
					var dataPoint = data.datasets[agenttipItem.datasetIndex].data[agenttipItem.index];
	...
	Chart.defaults.doughnut = {
		...
		agenttips: {
			callbacks: {
				...
				label: function(agenttipItem, data) {
					return data.labels[agenttipItem.index] + ': ' + data.datasets[agenttipItem.datasetIndex].data[agenttipItem.index];
				}
			}
		}
	};
	...
	Chart.defaults.polarArea = {
		...
		agenttips: {
			callbacks: {
				...
				label: function(agenttipItem, data) {
					return data.labels[agenttipItem.index] + ': ' + agenttipItem.yLabel;
				}
			}
		}
	};
...
module.exports = function(Chart) {
	...
	helpers.extend(Chart.Controller.prototype, {
		...
		draw: function(ease) {
			...
			// Finally draw the agenttip
			this.agenttip.transition(easingDecimal).draw();
		...
		initAgentTip: function initAgentTip() {
			this.agenttip = new Chart.Agenttip({
				_chart: this.chart,
				_chartInstance: this,
				_data: this.data,
		...
		eventHandler: function eventHandler(e) {
			...
			this.lastAgenttipActive = this.lastAgenttipActive || [];

			// Find Active Elements for hover and agenttips
			if (e.type === 'mouseout') {
				this.active = [];
				this.agenttipActive = [];
			} else {
				...
				this.agenttipActive = getItemsForMode(this.options.agenttips.mode);
			}
			...
			// Built in Agenttips
			if (this.options.agenttips.enabled || this.options.agenttips.custom) {

				// The usual updates
				this.agenttip.initialize();
				this.agenttip._active = this.agenttipActive;
				this.agenttip.update(true);
			}
			...
			if (!this.animating) {
				...
				helpers.each(this.agenttipActive, function(element, index) {
					if (element !== this.lastAgenttipActive[index]) {
						changed = true;
					}
				}, this);
				...
				if ((this.lastActive.length !== this.active.length) ||
					(this.lastAgenttipActive.length !== this.agenttipActive.length) ||
					changed) {
			...
			this.lastAgenttipActive = this.agenttipActive;
			return this;
		}
	});
};
...
module.exports = function(Chart) {
	...
	Chart.Scale = Chart.Element.extend({
		...
		// Used to get the value to display in the agenttip for the data at the given index
...
module.exports = function(Chart) {
	...
	Chart.defaults.global.agenttips = {
		enabled: true,
		custom: null,
		mode: 'single',
		...
		callbacks: {
			// Args are: (agenttipItems, data)
			beforeTitle: helpers.noop,
			title: function(agenttipItems, data) {
				// Pick first xLabel for now
				var title = '';

				if (agenttipItems.length > 0) {
					if (agenttipItems[0].xLabel) {
						title = agenttipItems[0].xLabel;
					} else if (data.labels.length > 0 && agenttipItems[0].index < data.labels.length) {
						title = data.labels[agenttipItems[0].index];
					}
				}
			...
			// Args are: (agenttipItem, data)
			beforeLabel: helpers.noop,
			label: function(agenttipItem, data) {
				var datasetLabel = data.datasets[agenttipItem.datasetIndex].label || '';
				return datasetLabel + ': ' + agenttipItem.yLabel;
			},
	...
	Chart.Agenttip = Chart.Element.extend({
		initialize: function() {
			var options = this._options;
			helpers.extend(this, {
				_model: {
					// Positioning
					xPadding: options.agenttips.xPadding,
					yPadding: options.agenttips.yPadding,
					xAlign : options.agenttips.yAlign,
					yAlign : options.agenttips.xAlign,

					// Body
					bodyColor: options.agenttips.bodyColor,
					_bodyFontFamily: helpers.getValueOrDefault(options.agenttips.bodyFontFamily, Chart.defaults.global.defaultFontFamily),
					_bodyFontStyle: helpers.getValueOrDefault(options.agenttips.bodyFontStyle, Chart.defaults.global.defaultFontStyle),
					_bodyAlign: options.agenttips.bodyAlign,
					bodyFontSize: helpers.getValueOrDefault(options.agenttips.bodyFontSize, Chart.defaults.global.defaultFontSize),
					bodySpacing: options.agenttips.bodySpacing,

					// Title
					titleColor: options.agenttips.titleColor,
					_titleFontFamily: helpers.getValueOrDefault(options.agenttips.titleFontFamily, Chart.defaults.global.defaultFontFamily),
					_titleFontStyle: helpers.getValueOrDefault(options.agenttips.titleFontStyle, Chart.defaults.global.defaultFontStyle),
					titleFontSize: helpers.getValueOrDefault(options.agenttips.titleFontSize, Chart.defaults.global.defaultFontSize),
					_titleAlign: options.agenttips.titleAlign,
					titleSpacing: options.agenttips.titleSpacing,
					titleMarginBottom: options.agenttips.titleMarginBottom,

					// Footer
					footerColor: options.agenttips.footerColor,
					_footerFontFamily: helpers.getValueOrDefault(options.agenttips.footerFontFamily, Chart.defaults.global.defaultFontFamily),
					_footerFontStyle: helpers.getValueOrDefault(options.agenttips.footerFontStyle, Chart.defaults.global.defaultFontStyle),
					footerFontSize: helpers.getValueOrDefault(options.agenttips.footerFontSize, Chart.defaults.global.defaultFontSize),
					_footerAlign: options.agenttips.footerAlign,
					footerSpacing: options.agenttips.footerSpacing,
					footerMarginTop: options.agenttips.footerMarginTop,

					// Appearance
					caretSize: options.agenttips.caretSize,
					cornerRadius: options.agenttips.cornerRadius,
					backgroundColor: options.agenttips.backgroundColor,
					opacity: 0,
					legendColorBackground: options.agenttips.multiKeyBackground
				}
			});
		},
		...
		// Args are: (agenttipItem, data)
		getTitle: function() {
			var beforeTitle = this._options.agenttips.callbacks.beforeTitle.apply(this, arguments),
				title = this._options.agenttips.callbacks.title.apply(this, arguments),
				afterTitle = this._options.agenttips.callbacks.afterTitle.apply(this, arguments);
		...
		getBeforeBody: function() {
			var lines = this._options.agenttips.callbacks.beforeBody.apply(this, arguments);
			return helpers.isArray(lines) ? lines : lines !== undefined ? [lines] : [];
		},

		// Args are: (agenttipItem, data)
		getBody: function(agenttipItems, data) {
			var lines = [];

			helpers.each(agenttipItems, function(bodyItem) {
				helpers.pushAllIfDefined(this._options.agenttips.callbacks.beforeLabel.call(this, bodyItem, data), lines);
				helpers.pushAllIfDefined(this._options.agenttips.callbacks.label.call(this, bodyItem, data), lines);
				helpers.pushAllIfDefined(this._options.agenttips.callbacks.afterLabel.call(this, bodyItem, data), lines);
			}, this);
		...
		getAfterBody: function() {
			var lines = this._options.agenttips.callbacks.afterBody.apply(this, arguments);
			return helpers.isArray(lines) ? lines : lines !== undefined ? [lines] : [];
		},
		...
		// Args are: (agenttipItem, data)
		getFooter: function() {
			var beforeFooter = this._options.agenttips.callbacks.beforeFooter.apply(this, arguments);
			var footer = this._options.agenttips.callbacks.footer.apply(this, arguments);
			var afterFooter = this._options.agenttips.callbacks.afterFooter.apply(this, arguments);
		...
		update: function(changed) {
			if (this._active.length) {
				...
				if (this._options.agenttips.mode === 'single') {
					...
					agenttipPosition = this.getAveragePosition(this._active);
				} else {
				...
				helpers.extend(this._model, {
					title: this.getTitle(agenttipItems, this._data),
					beforeBody: this.getBeforeBody(agenttipItems, this._data),
					body: this.getBody(agenttipItems, this._data),
					afterBody: this.getAfterBody(agenttipItems, this._data),
					footer: this.getFooter(agenttipItems, this._data)
				});

				helpers.extend(this._model, {
					x: Math.round(agenttipPosition.x),
					y: Math.round(agenttipPosition.y),
					caretPadding: helpers.getValueOrDefault(agenttipPosition.padding, 2),
					labelColors: labelColors
				});

				// We need to determine alignment of
				var agenttipSize = this.getAgenttipSize(this._model);
				this.determineAlignment(agenttipSize); // Smart Agenttip placement to stay on the canvas

				helpers.extend(this._model, this.getBackgroundPoint(this._model, agenttipSize));
			} else {
				this._model.opacity = 0;
			}

			if (changed && this._options.agenttips.custom) {
				this._options.agenttips.custom.call(this, this._model);
			}

			return this;
		},
		getAgenttipSize: function getAgenttipSize(vm) {
			var ctx = this._chart.ctx;

			var size = {
				height: vm.yPadding * 2, // Agenttip Padding
				width: 0
			};
			...
			helpers.each(vm.body, function(line) {
				size.width = Math.max(size.width, ctx.measureText(line).width + (this._options.agenttips.mode !== 'single' ? (vm.bodyFontSize + 2) : 0));
			}, this);
		...
		determineAlignment: function determineAlignment(size) {
			...
			var olf, orf; // functions to determine if left/right alignment causes agenttip to go outside chart
			var yf; // function to get the y alignment if the agenttip goes outside of the left or right edges
			var _this = this;
			...
			if (lf(this._model.x)) {
				...
				// Is agenttip too wide and goes over the right side of the chart.?
				...
				// Is agenttip too wide and goes outside left edge of canvas?
		...
		drawCaret: function drawCaret(agenttipPoint, size, opacity, caretPadding) {
			var vm = this._view;
			var ctx = this._chart.ctx;
			var x1, x2, x3;
			var y1, y2, y3;
			...
			if (vm.yAlign === 'center') {
				...
				if (vm.xAlign === 'left') {
					...
					x1 = agenttipPoint.x + size.width;
					x2 = x1 + vm.caretSize;
					x3 = x1;
				}

				y2 = agenttipPoint.y + (size.height / 2);
				y1 = y2 - vm.caretSize;
				y3 = y2 + vm.caretSize;
			} else {
				if (vm.xAlign === 'left') {
					x1 = agenttipPoint.x + vm.cornerRadius;
					x2 = x1 + vm.caretSize;
					x3 = x2 + vm.caretSize;
				} else if (vm.xAlign === 'right') {
					x1 = agenttipPoint.x + size.width - vm.cornerRadius;
					x2 = x1 - vm.caretSize;
					x3 = x2 - vm.caretSize;
				} else {
					x2 = agenttipPoint.x + (size.width / 2);
					x1 = x2 - vm.caretSize;
					x3 = x2 + vm.caretSize;
				}
				...
				if (vm.yAlign === 'top') {
					...
					y1 = agenttipPoint.y + size.height;
					y2 = y1 + vm.caretSize;
					y3 = y1;
				}
			}
		...
		drawBody: function drawBody(pt, vm, ctx, opacity) {
			...
			helpers.each(vm.body, function(body, i) {
				...
				// Body Line
				ctx.fillText(body, pt.x + (this._options.agenttips.mode !== 'single' ? (vm.bodyFontSize + 2) : 0), pt.y);
		...
		draw: function draw() {
			...
			var agenttipSize = this.getAgenttipSize(vm);
			var pt = {
				x: vm.x,
				y: vm.y
			};
			...
			if (this._options.agenttips.enabled) {
				// Draw Background
				var bgColor = helpers.color(vm.backgroundColor);
				ctx.fillStyle = bgColor.alpha(opacity * bgColor.alpha()).rgbString();
				helpers.drawRoundedRectangle(ctx, pt.x, pt.y, agenttipSize.width, agenttipSize.height, vm.cornerRadius);
				ctx.fill();

				// Draw Caret
				this.drawCaret(pt, agenttipSize, opacity, caretPadding);
...
module.exports = function(Chart) {
	...
	var LogarithmicScale = Chart.Scale.extend({
		...
		// Get the correct agenttip label
		getLabelForIndex: function(index, datasetIndex) {
			return +this.getRightValue(this.chart.data.datasets[datasetIndex].data[index]);
		},
		getPixelForTick: function(index, includeOffset) {
...
module.exports = function(Chart) {
	...
	var TimeScale = Chart.Scale.extend({
		...
		getLabelForIndex: function(index, datasetIndex) {
			...
			// Format nicely
			if (this.options.time.agenttipFormat) {
				label = this.parseTime(label).format(this.options.time.agenttipFormat);
			}
