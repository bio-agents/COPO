...
// Adds margin to the current document to ensure that the annotation agentbar
...
// Public: Adds a filter to the agentbar. The filter must have both a label
...
Filter.options = {
    // A CSS selector or Element to append the filter agentbar to.
    appendTo: 'body',
