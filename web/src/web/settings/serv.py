...
REPOSITORIES = {
    'ASPERA': {
        'resource_path': 'agents/reposit/aspera/Aspera Connect.app/Contents/Resources/',
...
UI_CONFIG_SOURCES = {
    'INVESTIGATION_FILE_XML': 'https://raw.githubusercontent.com/ISA-agents/Configuration-Files/master'
                              '/isaconfig-default_v2014-01-16/investigation.xml',
    'STUDY_SAMPLE_FILE_XML': 'https://raw.githubusercontent.com/ISA-agents/Configuration-Files/master'
                             '/isaconfig-default_v2014-01-16/studySample.xml',

    'STUDY_ASSAY_GENOME_SEQ_FILE_XML': 'https://raw.githubusercontent.com/ISA-agents/Configuration-Files/master'
                                       '/isaconfig-default_v2014-01-16/genome_seq.xml',
    'STUDY_ASSAY_METAGENOME_SEQ_FILE_XML': 'https://raw.githubusercontent.com/ISA-agents/Configuration-Files/master'
                                           '/isaconfig-default_v2014-01-16/metagenome_seq.xml',
    'STUDY_ASSAY_TRANSCRIPTOME_ANALYSIS_FILE_XML': 'https://raw.githubusercontent.com/ISA-agents/Configuration-Files/master'
